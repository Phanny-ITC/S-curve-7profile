...
/*
 * Accel_Stepper_Move
 * stepper : Pointer to stepper struct
...
static void execute_phase_1(S_curve_t* stepper){
        //if(s_c->t <= s_c->t1)
...
static void execute_phase_2(S_curve_t* stepper){
        // int j = 0;
...
static void execute_phase_3(S_curve_t* stepper){
...
static void execute_phase_4(S_curve_t* stepper){
...
static void execute_phase_5(S_curve_t* stepper){
...
static void execute_phase_6(S_curve_t* stepper){
        // int j = 0;
...
static void execute_phase_7(S_curve_t* stepper){
...
//		      status.running = false;
	    ...
	    case PHASE1:
	        ...
	        if(stepper->t >= stepper->t1){
	        	if(stepper->t1 != stepper->t2){
	        		stepper->run_state = PHASE2;
	        	}else if(stepper->t1 == stepper->t2){
		        	stepper->run_state = PHASE3;
		        }
	        }
	        break;
	    case PHASE2:
	    ...
	    case PHASE3:
            ...
            if (stepper->t >= stepper->t3){
	        	if(stepper->t3 != stepper->t4){
	        		stepper->run_state = PHASE4;
	        	}else if(stepper->t3 == stepper->t4){
		        	stepper->run_state = PHASE5;
		        }
            }
            break;
	    case PHASE4:
	    ...
	    case PHASE5:
            ...
            if (stepper->t >= stepper->t5){
	        	if(stepper->t5 != stepper->t6){
	        		stepper->run_state = PHASE6;
	        	}else if(stepper->t5 == stepper->t6){
		        	stepper->run_state = PHASE7;
		        }
            }
            break;
	    case PHASE6:
...
static void run_stepper(S_curve_t* stepper){
